  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 48px" }}>
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        <h1 style={{ fontSize: "32px", fontWeight: "800", color: "#0A1628", marginBottom: "8px" }}>USA Financial Plan Generator</h1>
        <p style={{ color: "#5F6877", fontSize: "16px" }}>Generate a complete US Financial Plan compliant with CFP Board standards.</p>
      </div>
          ...
          {planText ? (
            <>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <h3 style={{ fontSize: "18px", fontWeight: "800", color: "#0A1628" }}>Generated Plan</h3>
            ...
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#8A94A6", textAlign: "center", gap: "16px" }}>
              ...
              <div>
                <p style={{ fontWeight: "700", color: "#0A1628", marginBottom: "4px" }}>No Plan Generated Yet</p>
                <p style={{ fontSize: "14px" }}>Fill out the form to generate a compliant US Financial Plan.</p>
              </div>
            </div>
          )}
        </div>
